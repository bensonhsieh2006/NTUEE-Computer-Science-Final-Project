...
: Returns the size of the palette (*MAXCOLORS* + 1 in BGI mode, or
  *MAXRGBCOLORS* + 1 in ARGB mode).
...
: Sets the line width and style. Default values: SOLID_LINE, 0,
NORMAL_WIDTH.
...
int *event* (void);
: Returns 1 if an event (mouse click or movement, key press, or *QUIT*)
  has occurred.
...
nvidia-driver-\* on GNU/Linux and automatic refresh. As far as I can
say, this is an NVIDIA driver problem.
...
opyright (c) 2014-2024 Guido Gonzato, PhD
